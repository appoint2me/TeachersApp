...
import com.example.mydschoolteachersapp.Adapters.AdapterRecyclerViewSection;
 ...
 */
public class SectionFragmentAttendance extends Fragment {
    ...
    public SectionFragmentAttendance() {
        ...
        StringRequest stringRequestGetSection = new StringRequest(Request.Method.POST, Config.URL_GET_SECTION_LIST, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    AdapterRecyclerViewSection adapterRecyclerViewSection = new AdapterRecyclerViewSection(mContext, mListSection, mClassId);
                    GridLayoutManager layoutManager = new GridLayoutManager(mContext, 2);
                    mRecyclerViewSection.setLayoutManager(layoutManager);
                    mRecyclerViewSection.setAdapter(adapterRecyclerViewSection);
                    adapterRecyclerViewSection.notifyDataSetChanged();
